...
typedef enum
{
  MAX31856_SAMPLING_1_TIMES   = 0b00000000, // all calcs 60hz / 1-shot: 155 + 0 =       155ms / auto: 90 + 0 =        90ms
  MAX31856_SAMPLING_2_TIMES   = 0b00010000, // all calcs 60hz / 1-shot: 155 + 1 * 34 =  189ms / auto: 90 + 1 * 17 =   107ms
  MAX31856_SAMPLING_4_TIMES   = 0b00100000, // all calcs 60hz / 1-shot: 155 + 3 * 34 =  257ms / auto: 90 + 3 * 17 =   141ms
  MAX31856_SAMPLING_8_TIMES   = 0b00110000, // all calcs 60hz / 1-shot: 155 + 7 * 34 =  393ms / auto: 90 + 7 * 17 =   209ms
  MAX31856_SAMPLING_16_TIMES  = 0b01000000, // all calcs 60hz / 1-shot: 155 + 15 * 34 = 665ms / auto: 90 + 15 * 17 =  345ms
} max31856_sampling_t;
...
class Adafruit_MAX31856 {
 public:
  ...
  void setNumberOfSamples(max31856_sampling_t type);
  uint8_t getCR1(void);
